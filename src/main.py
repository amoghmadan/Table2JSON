...
class Table2JSON(object, metaclass=type):
    """Table 2 JSON"""
    ...
    extra_optional_arguments: list = [
        {
            ...
            "long": "--outfile",
            "type": str,
            "default": "output-[{now}].json".format(now=now),
    ...
    def __init__(self: Table2JSON) -> None:
        ...
        # Parser / Sub Parser
        parser: ArgumentParser = ArgumentParser(description="Table 2 JSON")
    ...
    def run(self: Table2JSON) -> None:
        ...
        with open(self.args.outfile, "w") as fp:
            json.dump(records, fp, indent=4, default=str)
